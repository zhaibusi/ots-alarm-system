...
public class NettyServiceHelper
{
     ...
     * @param alarmInfo
     */
    public void alarmTrapHandler(String alarmInfo)
    {
        if (MapUtils.isNotEmpty(NettySocketGroup.HAND_CONNECT_CHANNEL_MAP))
        {
            NettySocketGroup.HAND_CONNECT_CHANNEL_MAP.forEach((k, v) -> {
                //直接推送
